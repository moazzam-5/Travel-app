    ...
    <v-container fluid>
      <v-row>
        ...
        <v-col cols="12" sm="12">
          ...
          <row class="beautiful-places-center">
            <v-col cols="12" sm="10">
              <v-row>
                <v-col cols="12" sm="4">
        ...
        <v-col cols="12" sm="12">
          ...
          <v-row class="section-center">
            <v-col cols="12" sm="10">
              <v-row>
                <v-col col="12" sm="2" v-for="(offer, i) in offers" :key="i">
                  <v-card class="mx-auto px-2 pt-6" height="200px" flat>
                    <div align="center" class="section-center">
                      <v-img
                        :src="offer.image"
                        height="100px"
                        width="100px"
        ...
        <v-col cols="12" sm="12">
          ...
          <v-sheet class="mx-auto" elevation="8" max-width="1300">
            ...
            >
              ...
              >
                <v-card
                  :color="isSelected ? 'primary' : 'grey-bg-red-lighten-1'"
                  class="ma-4"
                  height="200"
                  width="190"
                  @click="toggle"
